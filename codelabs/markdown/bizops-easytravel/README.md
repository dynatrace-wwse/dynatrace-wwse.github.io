summary: BizOps with Easytravel
id: bizops-easytravel
categories: bizops
tags: bizops
status: Published 
authors: Sergio Hinojosa

# BizOps with Easytravel
<!-- ------------------------ -->
...
![BizOpsConfigurator](img/BizOpsConfig-2.png)

Click on **Deploy Tenant Overview** and select the **BizOps Template**

![BizOpsConfigurator](img/BizOpsConfig-4.png)
